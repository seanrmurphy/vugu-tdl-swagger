...
create_rest_api() {
  RESTAPIID=$(aws apigateway import-rest-api --cli-binary-format raw-in-base64-out --body file://$PWD/swagger.yaml --profile $PROFILE | jq -r '.id')
